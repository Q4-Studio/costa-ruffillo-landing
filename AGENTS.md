...
- Facebook sections use direct `https://www.facebook.com/plugins/page.php?...tabs=timeline...` iframes. Avoid the Meta SDK `fb-page` widget here; previous versions showed blank/loading embeds.
